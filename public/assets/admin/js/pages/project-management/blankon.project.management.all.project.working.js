// 'use strict';
// var BlankonProjectManagementAllProjectWorking = function () {
...
//         // =========================================================================
//         init: function () {
//             BlankonProjectManagementAllProjectWorking.handleDatatable();
//             BlankonProjectManagementAllProjectWorking.handleDatatableColors();
//         },
...
//                 'ajax': {
//                     'url': getBaseURL+'/assets/admin/data/project-working/datatable-sample.json'
//                 },
//                 'columnDefs': [
//                     {
//                         'targets': 0,
...
//                         'targets': 3,
//                         'render': function ( data, type, full, meta ) {
//                             return '<span class="label label-primary">'+ data +' Pending</span>'
//                         }
//                     },
//                     {
//                         'targets': 6,
...
//                             }
//                             if(data == 'behind'){
//                                 return '<span class="label label-danger">Behind</span>'
//                             }
//                         }
//                     },
//                     {
...
//                     BlankonProjectManagementAllProjectWorking.handleActionViewDatatable();
//                     BlankonProjectManagementAllProjectWorking.handleActionEditDatatable();
//                     BlankonProjectManagementAllProjectWorking.handleActionDeleteDatatable();
//                 }
//             });
...
//                 var tableLanguage = BlankonProjectManagementAllProjectWorking.handleNotificationDatatable('Table language '+$(this).data('title'));
...
//                 // Call notifications
//                 BlankonProjectManagementAllProjectWorking.handleNotificationDatatable($(this).text()+' Column');
...
//                     '</div>' +
//                     '<div class="form-group">' +
//                     '<label class="col-sm-3 control-label">All Tasks :</label>' +
//                     '<div class="col-sm-9">' +
//                     '<p class="form-control-static">' + $('<div/>').text(data[3]).html() + ' Pending task</p>'+
//                     '</div>' +
//                     '</div>' +
//                     '<div class="form-group">' +
...
//                 var $table = $($dlg.data('btn')).closest('table');
//                 var data = $table.DataTable().row($tr).data();
//                 var selectStatNew = (data[6] == 'in progress') ? "selected" : "";
//                 var selectStatExp = (data[6] == 'behind') ? "selected" : "";
...
//                     '<option '+selectStatNew+'>In Progress</option>' +
//                     '<option '+selectStatExp+'>Behind</option>' +
//                     '</select>' +
//                     '</div>' +
//                     '</div>' +
//                     '</form>';
...
//                 // Call notifications
//                 BlankonProjectManagementAllProjectWorking.handleNotificationDatatable('Table color '+$(this).data('color'));
//             });
//         }
...
// // Call main app init
// BlankonProjectManagementAllProjectWorking.init();